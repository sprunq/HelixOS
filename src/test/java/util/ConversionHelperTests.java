...
public class ConversionHelperTests {
    ...
    public void SimpleConversionTest() {
        ...
        char[] converted = ConversionH.itoa(20, 10);
    ...
    public void ZeroConversionTest() {
        ...
        char[] converted = ConversionH.itoa(0, 10);
        Assert.assertArrayEquals(expected, converted);
    }
    ...
    public void BinaryConversionTest() {
        ...
        char[] converted = ConversionH.itoa(10, 2);
        Assert.assertArrayEquals(expected, converted);
    }
    ...
    public void HexConversionTest() {
        ...
        char[] converted = ConversionH.itoa(20, 16);
        Assert.assertArrayEquals(expected, converted);
    }
    ...
    public void OctalConversionTest() {
        ...
        char[] converted = ConversionH.itoa(20, 8);
        Assert.assertArrayEquals(expected, converted);
    }
    ...
    public void LargeDecimalConversionTest() {
        ...
        char[] converted = ConversionH.itoa(123456789, 10);
        Assert.assertArrayEquals(expected, converted);
    }

    @Test
    public void DecConversionManyTest() {
        for (int i = 0; i < 1_000_000; i++) {
            char[] expected = Integer.toString(i, 10).toUpperCase().toCharArray();
            char[] actual = ConversionH.itoa(i, 10);
            Assert.assertArrayEquals(expected, actual);
        }
    }

    @Test
    public void DecConversionManyNegativeTest() {
    ...
    public void ZeroHexConversionTest() {
        char[] expected = new char[] { '0' };
        char[] converted = ConversionH.itoa(0, 16);
        Assert.assertArrayEquals(expected, converted);
    }
    ...
    public void HexConversionManyTest() {
        for (int i = 0; i < 1_000_000; i++) {
            ...
            char[] actual = ConversionH.itoa(i, 16);
            Assert.assertArrayEquals(expected, actual);
        }
    }
    ...
    public void ItoCTest() {
        ...
        for (int i = 0; i < 36; i++) {
            char actual = ConversionH.itoc(i);
    ...
    public void ItoCOutOfRangeTest() {
        char actual = ConversionH.itoc(37);
        Assert.assertEquals('\0', actual);
    }

    @Test
    public void ItoCOutOfRangeTest2() {
        char actual = ConversionH.itoc(-1);
        Assert.assertEquals('\0', actual);
    }
