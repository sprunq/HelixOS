...
public class BitHelperTests {
    ...
    public void TestGetFlag() {
        ...
        Assertions.assertEquals(true, BitHelper.getFlag(data, 0));
        Assertions.assertEquals(false, BitHelper.getFlag(data, 1));
        Assertions.assertEquals(false, BitHelper.getFlag(data, 2));
        Assertions.assertEquals(false, BitHelper.getFlag(data, 3));
        Assertions.assertEquals(true, BitHelper.getFlag(data, 4));
        Assertions.assertEquals(true, BitHelper.getFlag(data, 5));
        Assertions.assertEquals(false, BitHelper.getFlag(data, 6));
        Assertions.assertEquals(false, BitHelper.getFlag(data, 7));
        Assertions.assertEquals(true, BitHelper.getFlag(data, 8));
        Assertions.assertEquals(true, BitHelper.getFlag(data, 8));
    }
    ...
    public void TestSetFlagTrue() {
        ...
        Assertions.assertEquals(true, BitHelper.getFlag(data, 3));
        Assertions.assertEquals(8, data);
    }
    ...
    public void TestSetFlagExistingTrue() {
        ...
        Assertions.assertEquals(data, BitHelper.setFlag(data, 1, true));
    }

    @Test
    public void TestSetFlagExistingFalse() {
        int data = BinaryHelper.bin(110010);
        Assertions.assertEquals(data, BitHelper.setFlag(data, 3, false));
    }
    ...
    public void TestSetRange2() {
        ...
        Assertions.assertEquals(false, BitHelper.getFlag(data, 0));
        Assertions.assertEquals(false, BitHelper.getFlag(data, 1));
        Assertions.assertEquals(true, BitHelper.getFlag(data, 2));
        Assertions.assertEquals(false, BitHelper.getFlag(data, 3));
    }
    ...
    public void TestSetRangeMaskedSet() {
        ...
        Assertions.assertEquals(false, BitHelper.getFlag(data, 0));
        Assertions.assertEquals(true, BitHelper.getFlag(data, 1));
        Assertions.assertEquals(false, BitHelper.getFlag(data, 2));
        Assertions.assertEquals(false, BitHelper.getFlag(data, 3));
        Assertions.assertEquals(false, BitHelper.getFlag(data, 4));
    }
    ...
    public void TestGetRangeSingleBit() {
        ...
        Assertions.assertEquals(1, range);
    }
    ...
    public void TestGetRangeWholeData() {
        ...
        Assertions.assertEquals(data, range);
    }
    ...
    public void TestGetFlagLargeIndex() {
        int data = BinaryHelper.bin(101010);
        Assertions.assertEquals(false, BitHelper.getFlag(data, 100));
    }
    ...
    public void TestGetRangeSingleBitLargeIndices() {
        ...
        Assertions.assertEquals(0, range);
    }
